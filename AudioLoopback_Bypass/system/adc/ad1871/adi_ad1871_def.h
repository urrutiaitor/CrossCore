...
/*!
 * @file:    adi_ad1871_def.h
 * @brief:   Private header file for AD1871 driver implementation.
 * @version: $Revision: 11128 $
 * @date:    $Date: 2012-08-29 04:24:56 -0400 (Wed, 29 Aug 2012) $
 *
 * @details
 *           This is a private header file for AD1871 Stereo Audio ADC driver
 *           that contains definitions used in AD1871 driver implementation.
 */

#ifndef __ADI_AD1871_DEF_H__
#define __ADI_AD1871_DEF_H__

/*=============  I N C L U D E S   =============*/

/* ADI AD1871 driver includes */
...
/*
 * SPORT Control register 1 value for AD1871 as Master
 ...
 */
#define ADI_AD1871_SPORT_SLAVE_RX_CTRL1         (0x5400u)

/*
 * SPORT Control register 2 value for AD1871 as Master
 * 24-bit wordlength, Secondary disabled, FS becomes L/R Clock, Left channel first
 */
#define ADI_AD1871_SPORT_SLAVE_RX_CTRL2         (0x0217u)

/*
 * SPORT Control register 1 value for AD1871 as Slave
 ...
 */
#define ADI_AD1871_SPORT_MASTER_RX_CTRL1        (0x1602u)

/*
 * SPORT Control register 2 value for AD1871 as Master
 * 24-bit wordlength, Secondary disabled, FS becomes L/R Clock, Left channel first
 */
#define ADI_AD1871_SPORT_MASTER_RX_CTRL2        (0x0217u)

#pragma pack (4)
/* Structure to handle AD1871 device instance */
typedef struct ADI_AD1871_DEV
{
    uint8_t                     SportDevMem[ADI_SPORT_DMA_MEMORY_SIZE]; /* Memory to handle a DMA driven SPORT Device */
    bool                        bIsEnabled;                             /* TRUE if AD1871 dataflow is enabled */
    bool                        bIsMaster;                              /* TRUE if AD1871 is the master */
    ...
    struct ADI_AD1871_DEV       *pPrevious;                             /* Pointer to previous device instance in chain */
    struct ADI_AD1871_DEV       *pNext;                                 /* Pointer to next device instance in chain */
} ADI_AD1871_DEV;
#pragma pack ()
